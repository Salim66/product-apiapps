...
<body>
    ...
    <header id="topnav">
        <div class="container">
            ...
            <div class="logo">
                <a href="index-2.html">
                    <img src="assets/images/logo_light.png" alt="" class="logo-light">
                    <img src="assets/images/logo_dark.png" alt="" class="logo-dark">
                </a>
            </div>
            <!-- End Logo container-->
    ...
    <section class="page-title parallax">
        <div data-parallax="scroll" data-image-src="assets/images/bg/19.jpg" class="parallax-bg"></div>
                    ...
                    <div class="sidebar">
                        <div class="widget">
                            ...
                            <ul class="nav">
                                ...
                                $categories = file_get_contents('http://localhost:8000/api/categories/view');
                                $category_arr = json_decode($categories);

                                foreach ($category_arr->all_data as $data) {
                                ?>

                                    <li><a href="category-wise-product-search.php?slug=<?php echo $data->slug ?>"><?php echo $data->name; ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            if (isset($_GET['slug'])) {
                                $slug = $_GET['slug'];
                                $category = file_get_contents('http://localhost:8000/api/categories/single-slug/' . $slug);
                                $category_arr = json_decode($category);
                                $category_id = $category_arr->data->id;
                            }


                            // get all data
                            $products = file_get_contents('http://localhost:8000/api/products/category-wise-search/' . $category_id);
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="shop-product">
                                        <div class="product-thumb">
                                            <a href="#">
                                                <img style="width: 255px; height: 190px;" src="http://localhost:8000/uploads/products/<?php echo $data->image; ?>" alt="">
                                            </a>
                                            <div class="product-overlay"><a href="shop-single.php?slug=<?php echo $data->slug ?>" class="btn btn-color-out btn-sm">View Details<i class="ti-bag"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-info">
                                            <h4 class="upper"><a href="#"><?php echo $data->name ?></a></h4><span>TK <?php echo $data->price ?></span>
