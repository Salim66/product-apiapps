...
<body>
  ...
  if (isset($_GET['slug'])) {
    // Get url single product id
    $slug = $_GET['slug'];
    // get product data by API 
    $data_json = file_get_contents('http://localhost:8000/api/products/single-slug/' . $slug);
        ...
        <div class="row">
          <div class="col-md-6">
            <div data-options="{&quot;animation&quot;: &quot;slide&quot;, &quot;controlNav&quot;: true}" class="flexslider nav-inside control-nav-dark">
              <ul class="slides">
                <li>
                  <img src="http://localhost:8000/uploads/products/<?php echo $data->data->image ?>" alt="">
                </li>
                <li>
                  <img src="http://localhost:8000/uploads/products/<?php echo $data->data->image ?>" alt="">
                </li>
          ...
          <div class="col-md-5 col-md-offset-1">
            <div class="title mt-0">
              <h2><?php echo $data->data->name ?><span class="red-dot"></span></h2>
            </div>
            <div class="single-product-price">
              <div class="row">
                <div class="col-xs-6">
                  <h3><span>TK <?php echo $data->data->price ?></span></h3>
                </div>
            ...
            <div class="single-product-desc">
              <p><?php echo $data->data->short_description ?></p>
            </div>
      ...
      <div class="product-tabs">
        ...
        <div class="tab-content">
          <div id="first-tab" role="tabpanel" class="tab-pane active">
            <p><?php echo $data->data->long_description ?></p>
          </div>
